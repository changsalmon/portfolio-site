    ...
    <header class="w-64 h-64">
      <div class="w-64 mt-24 ml-2 relative md:fixed">
        <div class="flex">
          ...
          <div>
            <h1 class="font-bold">Arata Okada</h1>
            <p class="text-xs text-justify">Arata Okadaのポートフォリオサイト</p>
          </div>
        </div>
        <div class="flex justify-around mt-5 text-xs">
          ...
          <a href="https://twitter.com/araooooo_" target="_blank" rel="noopener noreferrer">
            <button>
              <fa-layers full-width class="fa-2x block mx-auto mb-1">
                <fa :icon="faTwitter" />
              </fa-layers>Twitter
          ...
          <a href="https://github.com/arata-okada" target="_blank" rel="noopener noreferrer">
            <button>
              <fa-layers full-width class="fa-2x block mx-auto mb-1">
                <fa :icon="faGithub" />
              </fa-layers>GitHub
